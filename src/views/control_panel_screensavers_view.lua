    ...
    if t == 'pipes' then
        ...
        elseif t == 'text3d' then
            ...
            self.preview.saver = Text3DView:new({
                ...
                rotation_mode_x = getVal(pending, settings, 'screensaver_text3d_rotation_mode_x', d and d.rotation_mode_x or 'continuous'),
                rotation_mode_y = getVal(pending, settings, 'screensaver_text3d_rotation_mode_y', d and d.rotation_mode_y or 'continuous'),
                rotation_mode_z = getVal(pending, settings, 'screensaver_text3d_rotation_mode_z', d and d.rotation_mode_z or 'continuous'),
                rotation_range_x = getVal(pending, settings, 'screensaver_text3d_rotation_range_x', d and d.rotation_range_x or 45),
                rotation_range_y = getVal(pending, settings, 'screensaver_text3d_rotation_range_y', d and d.rotation_range_y or 45),
                rotation_range_z = getVal(pending, settings, 'screensaver_text3d_rotation_range_z', d and d.rotation_range_z or 45),
                ...
                depth_oscillate = getVal(pending, settings, 'screensaver_text3d_depth_oscillate', d and d.depth_oscillate or false),
                depth_speed = getVal(pending, settings, 'screensaver_text3d_depth_speed', d and d.depth_speed or 0.5),
                depth_min = getVal(pending, settings, 'screensaver_text3d_depth_min', d and d.depth_min or 5),
                depth_max = getVal(pending, settings, 'screensaver_text3d_depth_max', d and d.depth_max or 15),
